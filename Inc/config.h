...
#define N_MOT_MAX       1250            // [rpm] Maximum motor speed limit
...
// #define ELECTRIC_BRAKE_MAX    60       // (0, 500) Maximum electric brake to be applied when input torque request is 0 (pedal fully released).
// #define ELECTRIC_BRAKE_THRES  55       // (0, 500) Threshold below at which the electric brake starts engaging.
...
#define INACTIVITY_TIMEOUT        18       // Minutes of not driving until poweroff. it is not very precise.
